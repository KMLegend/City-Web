...
function ol() {
  ...
  var n = re(),
    ...
    y = (jt.exports = function (m, b, x) {
      ...
      var S = u(m);
      return (
        t(S, "source") || (S.source = g(p, typeof b == "string" ? b : "")), m
      );
    });
  return (
...
function Nh() {
  ...
  var n = le(),
    e = Za();
  return (
    n({ target: "RegExp", proto: !0, forced: /./.exec !== e }, { exec: e }), Eo
  );
}
var aa, Do;
function Ja() {
...
(function (n) {
  ...
  function a(o, u, l, h, c, v) {
    return (
      ...
      i(function (f, g, d, p) {
        ...
        return (
          f.sweepFlag !== void 0 && 0 > O && (f.sweepFlag = +!f.sweepFlag), f
        );
      })
    );
  }
  ...
  (n.ROUND = function (o) {
    ...
    (n.ANNOTATE_ARCS = function () {
      return i(function (o, u, l) {
        return (
          o.relative && ((u = 0), (l = 0)), T.ARC === o.type && Ia(o, u, l), o
        );
      });
    }),
    (n.CLONE = s),
...
function Sf(n, e, r, t, i, a) {
  ...
  f.next = v;
  for (
    var p = null, y = null, m = 0, b = 0, x = bf[a], S = xf[a], E = 0;
    E < i;
    E++
  ) {
    f = v;
  ...
  getColor(e) {
    ...
    return (
      this.isNormalizedColor ||
        ((this.isNormalizedColor = !0), (r = If(r)), (this.value = r)),
      r
    );
  }
  getDpi() {
...
class ac extends Y {
  ...
  path(e) {
    ...
    return (
      e && (e.beginPath(), e.moveTo(r, t), e.lineTo(i, a)), new Pe(r, t, i, a)
    );
  }
  getMarkers() {
    ...
    r === "underline" && e.beginPath(),
      i.forEach((s, o) => {
        ...
        e.save(),
          ...
          e.restore(),
          r === "underline" &&
            (o === 0 && e.moveTo(u.x, u.y + t / 8), e.lineTo(l.x, l.y + t / 5));
      }),
      r === "underline" &&
        ((e.lineWidth = t / 20),
        (e.strokeStyle = a),
    ...
    for (
      ...
      for (var h = 0; h < i; h++) {
        var c = Rr(u.data, h, l, i, a, 0),
          ...
          d =
            ie(o, 0, c) + ie(o, 1, v) + ie(o, 2, f) + ie(o, 3, g) + ie(o, 4, 1),
          p =
            ie(o, 5, c) + ie(o, 6, v) + ie(o, 7, f) + ie(o, 8, g) + ie(o, 9, 1),
          y =
            ie(o, 10, c) +
            ie(o, 11, v) +
            ie(o, 12, f) +
